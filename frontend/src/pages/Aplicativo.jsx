    ...
    return (
      <div className="planos-page">
        ...
        {/* Context Images Section */}
          ...
          <section className="vantagens-sec" id='agendamento'>
            <div className="vantagens-container">
              <div className="vantagens-left">

                <div className="vantagens-card-left">
                  <h2 className="vantagens-title">Pronto para revolucionar sua gestão rural?</h2>
                  <p className="vantagens-subtitle">
                    Junte-se a centenas de produtores que já transformaram sua gestão com a TratorBR.
                  </p>
                  <button className="vantagens-btn"> <CalendlyLink /> </button>

                  <div className="vantagens-image">
                    <svg className="watch-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">

                      <circle cx="100" cy="100" r="45" fill="none" stroke="#1a1a1a" strokeWidth="8" /> <circle cx="100" cy="100" r="5" fill="#1a1a1a" /> <line x1="100" y1="100" x2="100" y2="65" stroke="#1a1a1a" strokeWidth="3" /> <line x1="100" y1="100" x2="130" y2="100" stroke="#1a1a1a" strokeWidth="3" />

                      <rect x="85" y="40" width="30" height="20" fill="#8B6F47" rx="2" /> <rect x="85" y="150" width="30" height="20" fill="#8B6F47" rx="2" />

                      <rect x="30" y="120" width="50" height="60" fill="#f5f5f5" stroke="#ddd" strokeWidth="2" rx="4" /> <line x1="35" y1="135" x2="75" y2="135" stroke="#ddd" strokeWidth="1" /> <line x1="35" y1="145" x2="75" y2="145" stroke="#ddd" strokeWidth="1" /> <line x1="35" y1="155" x2="65" y2="155" stroke="#ddd" strokeWidth="1" />
              ...
              <div className="vantagens-right">
                <div className="vantagens-card-right">
                  <h3 className="vantagens-benefits-title">Vantagens</h3>
                  ...
                  <div className="vantagens-list">
                    ...
                    <div className="vantagem-item">
                      <div className="vantagem-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                          <circle cx="12" cy="8" r="7" /> <path d="M12 15c-4.418 0-8 1.79-8 4v2h16v-2c0-2.21-3.582-4-8-4z" />
                          <path d="M12 8l2 2m-2-2l-2 2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                      </div>
                      <div className="vantagem-text">
                        <p className="vantagem-description">Conhecer o app de perto, com os especialistas!</p>
                      </div>
                    </div>
                    ...
                    <div className="vantagem-item">
                      <div className="vantagem-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                          <rect x="3" y="4" width="18" height="14" rx="2" ry="2" /> <line x1="16" y1="2" x2="16" y2="6" /> <line x1="8" y1="2" x2="8" y2="6" /> <line x1="3" y1="10" x2="21" y2="10" />
                        </svg>
                      </div>
                      <div className="vantagem-text">
                        <p className="vantagem-description">Agende o melhor horário para você ou sua equipe!</p>
                      </div>
                    </div>
                    ...
                    <div className="vantagem-item">
                      <div className="vantagem-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" /> <path d="M12 6v6l4 2.5" />
                        </svg>
                      </div>
                      <div className="vantagem-text">
                        <p className="vantagem-description">Venha conferir todo o ecossistema da TratorBR.</p>
                      </div>
                    </div>
                  </div>

                  <Link to="/sobre-app#demonstracao">
                    <p className="vantagens-footer-text">Consulte os termos</p>
                  </Link>
